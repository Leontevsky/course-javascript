...
function isAllTrue(array, fn) {
  // Если тип fn не является функцией - выбрасываем исключение с текстом fn is not a function
  if (typeof fn !== 'function') {
    throw new Error('fn is not a function');
  }

  // Если то что мы принимаем не массив или пустой массив, выбрасываем исключение с текстом empty array
  if (!Array.isArray(array) || !array.length) {
    throw new Error('empty array');
  }

  // Перебираем все элементы массива. В каждой итерации для текущего элемента вызываем нашу функцию. И если хотябы одна итерация возвращает false - мы также возвращаем false.
